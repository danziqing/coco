...
router.get('/list', requirePassword, requireAdmin, (req, res) => {
    try {
...
// Generate Share Link
router.post('/generate', requirePassword, requireAdmin, (req, res) => {
    try {
...
// Revoke Share Link
router.post('/revoke', requirePassword, requireAdmin, (req, res) => {
    try {
...
router.post('/delete', requirePassword, requireAdmin, (req, res) => {
    try {
        const { signature } = req.body;
